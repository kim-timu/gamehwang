document.addEventListener('DOMContentLoaded', () => {
    ...
    // Hardcoded for Level 2 (6x6)
    const dimension = 6;
    const nextLevelURL = 'imagemat03.html'; // Redirect to next level
    ...
    function checkWinCondition() {
        ...
        if (matchedPairs === numPairs) {
            setTimeout(() => {
                alert(`Congratulations! You cleared Level 2 (6x6) in ${moves} moves!`);
