document.addEventListener('DOMContentLoaded', () => {
    ...
    // Game Settings (Hardcoded for Hard level)
    const currentDifficulty = { name: 'Hard', rows: 16, cols: 30, mines: 99 };
    ...
    function endGame(isWin) {
        ...
        if (isWin) {
            resultTextEl.textContent = `You cleared Hard level in ${timeElapsed}s! You've mastered all levels!`;
