document.addEventListener('DOMContentLoaded', () => {
    ...
    // Game Settings (Hardcoded for Level 2: Intermediate)
    const currentDifficulty = { name: 'Intermediate', rows: 7, cols: 7, bananas: 6 }; // Changed 'mines' to 'bananas'
    const nextLevelURL = 'bananahunt03.html'; // Redirect to next level
